...
**Also known as**: export vector, save vector graphics

## Description

> This documentation was AI-generated. If you find any errors or have suggestions for improvement, please feel free to contribute! [Edit on GitHub](https://github.com/hanzoui/embedded-docs/blob/main/hanzo_studio_embedded_docs/docs/SaveSVGNode/en.md)
...
|-------------|-----------|-------------|
| `ui` | DICT | Returns file information including filename, subfolder, and type for display in the Hanzo Studio interface |
